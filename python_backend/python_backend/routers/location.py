...
GEOAPIFY_URL = f"https://maps.geoapify.com/v1/staticmap?style=osm-liberty&width=600&height=600&center=lonlat:{GEOAPIFY_LONLAT}&zoom=17&pitch=43&apiKey={GEOAPIFY_APIKEY}"
