...
{:then track}
	...
	{:else}
		<div
			class="flex flex-col gap-8 font-[Noto_Sans] items-center p-8 rounded-sm shadow-sm dark:shadow-none dark:outline-2 outline-base-content/10 md:min-w-2/5"
		>
			<span
			...
			<div class="flex gap-8 items-center self-start">
				...
				<div class="flex flex-col gap-4">
					<a
						...
						target="_blank"
						class="tooltip text-lg md:text-xl text-base-content"
					...
					<span
						class="tooltip text-md md:text-lg text-base-content/60"
					...
					<span
						class="tooltip text-sm md:text-md text-base-content/40"
